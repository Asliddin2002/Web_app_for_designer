...
const Contacts = () => {
  return (
    <section id="contact">
      ...
      />
      <div className="flex flex-col space-y-[50px] sm:flex-row mx-auto max-w-[550px] justify-between mb-[70px]">
        <div className="flex flex-col items-center">
          <Devider text="Location" count={"01"} />
          <h3 className="text-[22px] font-bold mt-[20px] sm:mt-[35px] mb-6">
            Welcome to visit
          </h3>
